...
namespace ApiAuthorization.IdentityServer.Data;
...
public class ApiAuthorizationDbContext<TUser> : IdentityDbContext<TUser>, IPersistedGrantDbContext
    ...
    /// <summary>
    ///     Gets or sets the <see cref="DbSet{ServerSideSession}" />.
    /// </summary>
    public DbSet<ServerSideSession> ServerSideSessions { get; set; }

    /// <summary>
    ///     Gets or sets the <see cref="DbSet{PushedAuthorizationRequest}" />.
    /// </summary>
