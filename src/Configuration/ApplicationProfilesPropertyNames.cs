...
/// <summary>
///     Constants used for storing information about application profiles in the <see cref="Client.Properties" /> or
///     <see cref="Resource.Properties" />
...
public static class ApplicationProfilesPropertyNames {
    ...
    ///     The Clients value will be <c>*</c> to indicate that all clients are allowed to access this resource or a space
    ///     separated list of
